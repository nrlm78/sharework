...
public class MedicineDaoImpl implements MedicineDao {
	...
	private final String SELECT_ALL_MEDICINE = 
			"select medicine_no,medicine_nm,menufacturer,expiry_month,expiry_year,price,quantity from medicine order by medicine_nm";
	// private final String SELECT_ALL_MEDICINE="";
